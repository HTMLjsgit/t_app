class RoomChannel < ApplicationCable::Channel
  ...
  def image_upload(data)
    room = Room.find params[:room_id]
    chat_post = room.chat_posts.create(message: "", user_id: current_user.id)
    ...
    chat_post_image = chat_post.chat_post_images.create(picture: "/uploads/chat_post_images/#{chat_post.id}/#{data["filename"]}")
